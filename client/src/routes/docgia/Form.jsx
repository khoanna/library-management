...
const Form = ({ isOpen, onClose, tuoi, reload }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (!hoTen || !loaiDocGia || !ngaySinh || !ngaySinh || !diaChi || !email || !gioiTinh || !ngayLamThe || !ngayHetHan) {
        ...
        if (age < tuoi || (age === tuoi && month < 0)) {
            alert("Bạn chưa đủ 18 tuổi để mượn sách.");
            return;
        }
        ...
        if (ngayLamTheDate > today) {
            alert("Ngày làm thẻ phải nhỏ hơn ngày hiện tại");
            return;
        }
                    ...
                    <div className="card-body p-6 bg-slate-100 dark:bg-slate-950 transition-colors">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <select
                                    value={loaiDocGia}
                                    onChange={(e) => setLoaiDocGia(e.target.value)}
                                    className="w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-500"
                                >
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input
                                    type="date"
                                    value={ngayLamThe}
                                    onChange={(e) => setNgayLamThe(e.target.value)}
                                    className="w-full border border-gray-300 rounded p-2 focus:outline-none focus:border-blue-500"
                                />
                            </div>
                            <div>
