...
const DocGia = () => {
  ...
  const load = async () => {
    ...
    console.log(data.danhSachDocGia);
  ...
  return (
    <div className="flex flex-col gap-y-4">
      ...
      <Form isOpen={isModalOpen} onClose={closeModal} tuoi={tuoiQuyDinh} reload={() => load()} />
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          <div className="card">
            ...
            <div className="card-body bg-slate-100 transition-colors dark:bg-slate-950">
              <p className="text-3xl font-bold text-slate-900 transition-colors dark:text-slate-50">{tuoiQuyDinh}</p>
              <div className="flex w-full justify-between mt-2">
                <div className="border-black dark:border-slate-500 input w-10/12 flex">
                  <input
                    ...
                    id="search"
                    placeholder="Sửa tuổi quy định"
                    className="w-full bg-transparent text-slate-900 outline-0 placeholder:text-slate-300 dark:text-slate-50"
                  />
                </div>
                <div className="w-fit cursor-pointer rounded-lg bg-blue-500/20 p-2 text-blue-500 transition-colors dark:bg-blue-600/20 dark:text-white font-bold" onClick={editTuoi}>
                  Sửa
                </div>
              </div>
            </div>
              ...
              <div className="flex w-full justify-between mt-2">
                <div className="border-black dark:border-slate-500 input w-10/12 flex">
                  <input
                    ...
                    id="search"
                    placeholder="Sửa số sách tối đa"
                    className="w-full bg-transparent text-slate-900 outline-0 placeholder:text-slate-300 dark:text-slate-50"
                  />
                </div>
              ...
              <div className="flex w-full justify-between mt-2">
                <div className="border-black dark:border-slate-500 input w-10/12 flex">
                  <input
                    ...
                    placeholder="Sửa số ngày mượn tối đa"
